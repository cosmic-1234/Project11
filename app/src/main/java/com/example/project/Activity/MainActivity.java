...
public class MainActivity extends AppCompatActivity {
    ...
    private void recyclerViewCategory() {
        ...
        categoryList.add(new CategoryDomain("recharge", "cat_1"));
        categoryList.add(new CategoryDomain("cafe", "cat_2"));
        categoryList.add(new CategoryDomain("session", "cat_3"));
        categoryList.add(new CategoryDomain("Drink", "cat_4"));
        categoryList.add(new CategoryDomain("workout", "cat_5"));
